...
VALUES
('1', '3', '127.0.0.1', 'administrator', NOW(), NOW());
...
CREATE TABLE `prong` (
  ...
  `prong_key` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `version` varchar(255) COLLATE utf8_unicode_ci,
  `created_on` datetime,
  `updated_on` datetime,
  UNIQUE KEY (`client_id`,`prong_key`),
...
CREATE TABLE `task`(
  ...
  `prong_id` int(11) unsigned NOT NULL,
  `dispatched` bool NOT NULL default 0,
  `responded` bool NOT NULL default 0,
  ...
  KEY(`responded`),
  PRIMARY KEY (`task_id`),
  UNIQUE KEY (`dispatch_log_id`),
  UNIQUE KEY (`response_log_id`),
...
(
  ...
  `cleanable` bool default 1,
  `notifiable` bool default 0,
  `created_on` datetime,
  PRIMARY KEY (`log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
