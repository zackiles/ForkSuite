...
class Restler extends EventDispatcher
{
    ...
    public $url;
    /**
     * The raw body of the request unmodified..
     * Only used in [PUT, POST, PATCH]
     *
     * @var string
     */

    public $requestRawBody;
    /**
    ...
    public function getRequestData($includeQueryParameters = true)
    {
        ...
        if ($this->requestMethod == 'PUT'
            ...
            if (is_array($r)){
                $r = array_merge($r, array(Defaults::$fullRequestDataName => $r));
            } else {
                $r = array(Defaults::$fullRequestDataName => $r);
            }
